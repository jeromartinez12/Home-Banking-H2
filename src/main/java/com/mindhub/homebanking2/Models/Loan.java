...
public class Loan {
    ...
    @ElementCollection //Is used to create list of embeddable objects. An embeddable object is data intended for use only in the object containing it.
    @Column(name="payments")//Give a column name
